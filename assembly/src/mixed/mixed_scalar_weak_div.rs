//! Mixed scalar weak divergence integrator.
use crate::integrator::QpData;
use crate::mixed::MixedBilinearIntegrator;

pub struct MixedScalarWeakDivergenceIntegrator;

impl MixedBilinearIntegrator for MixedScalarWeakDivergenceIntegrator {
