//! Vector FE boundary flux linear form integrator (MFEM: VectorFEBoundaryFluxLFIntegrator).
...
pub struct VectorFEBoundaryFluxLFIntegrator<V: VectorCoeff> {
    pub f: V,
}

impl<V: VectorCoeff> LinearIntegrator for VectorFEBoundaryFluxLFIntegrator<V> {
