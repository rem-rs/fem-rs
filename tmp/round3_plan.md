...
- 抽查（主会话复跑）：`mini_nurbs_ex3` **33540 dof / 516 ess / ARF 0.918732 / L2 8.41512e-06** ✓（= C++）；`-r 1` ARF 0.128859 / 0.0398024 ✓；`mini_nurbs_ex1 -o 2` ARF **0.588878** 不劣化 ✓；ex3 `beam-tri -o 1` **8.01477893043346e-2** ✓、`beam-tet -o 2` **1.57652991777406e-2** ✓；ex3 默认（内置 beam-tet `-o 1`）**3.91630923150637e-1**（round 18 记录 …**634**，差 3 ulp 且线程无关 —— 见 D79 的二分）。
