...
use crate::{PrintLevel, SolveResult, SolverConfig};
...
pub fn solve_jacobi_sli(
    ...
    for k in 0..cfg.max_iter {
        ...
        if residual < cfg.atol || residual / b_norm < cfg.rtol {
            if matches!(
                cfg.effective_print_level(),
                PrintLevel::Summary | PrintLevel::Iterations | PrintLevel::Debug
            ) {
