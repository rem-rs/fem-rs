...
// D646: `symplectic::HamiltonianSiavSolver` (a hand copy of the SIAV tableau
// in `(q, p)` form) was removed — no consumers outside its own tests; use
// `mfem_ode::SiavSolver` (ex20 pattern).  `Yoshida4` is a distinct algorithm
// and stays.
pub use symplectic::Yoshida4;
pub use mfem_ode::{
