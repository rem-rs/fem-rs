//! # Parallel Example 6 — Parallel Poisson on AMR-refined mesh
//! (analogous to MFEM pex6)
//!
//! Uses a finer mesh (n×n) to simulate AMR refinement in parallel.
//!
//! Usage:
//!   cargo run --example mfem_pex6_parallel_amr
//!   cargo run --example mfem_pex6_parallel_amr -- --n 32 --ranks 4
