//! # Parallel Example 9 — Parallel Poisson (GMRES, DG-style)
//! (analogous to MFEM pex9)
//!
//! Usage:
//!   cargo run --example mfem_pex9_parallel_dg_advection -- --n 8 --ranks 2
...
fn main() {
    ...
    launcher.launch(move |comm| {
        ...
        let res = fem_parallel::par_solve_gmres_jacobi(&a_mat, &rhs, &mut u, 30, &cfg).unwrap();
    ...
    println!("=== Parallel Poisson (GMRES) ===");
