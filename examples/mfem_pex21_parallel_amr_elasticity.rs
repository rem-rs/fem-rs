...
fn main() {
    ...
    launcher.launch(move |comm| {
        ...
        let (n_total, sol_norm, status) = if rank == 0 {
            ...
            let cfg = SolverConfig { rtol: 1e-12, max_iter: 2000, verbose: false, ..Default::default() };
