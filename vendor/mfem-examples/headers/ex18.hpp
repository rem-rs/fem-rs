...
//
//            (u_t, v)_T - (F(u), ? v)_T + <F?(u, n), [[v]]>_F = 0.
//
...
public:
    ...
    *
    * @param vfes_ vector finite element space. Only tested for DG [P?]?
   ...
   /**
    * @brief Apply nonlinear form to obtain M?1(DIVF + JUMP HAT(F))
    *
